      ...
      <div class="main-container">
        <div class="first-container">
          ...
          <p class="contact-para">
            <img className='profile-img' src='/profile.png' alt='profile-img'></img>
          </p>
          <ul class="contact-list">
            <li class="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16px" fill="#fff" viewBox="0 0 479.058 479.058" height="16px">
                <path d="M434.146 59.882H44.912C20.146 59.882 0 80.028 0 104.794v269.47c0 24.766 20.146 44.912 44.912 44.912h389.234c24.766 0 44.912-20.146 44.912-44.912v-269.47c0-24.766-20.146-44.912-44.912-44.912zm0 29.941c2.034 0 3.969.422 5.738 1.159L239.529 264.631 39.173 90.982a14.902 14.902 0 0 1 5.738-1.159zm0 299.411H44.912c-8.26 0-14.971-6.71-14.971-14.971V122.615l199.778 173.141c2.822 2.441 6.316 3.655 9.81 3.655s6.988-1.213 9.81-3.655l199.778-173.141v251.649c-.001 8.26-6.711 14.97-14.971 14.97z"></path>
              </svg>
              <a href="#" class="contact-link">upesopen@gmail.com</a>
            </li>
            <li class="contact-item">
              ...
              <a href="#" class="contact-link">+91 1234567890</a>
            </li>
            <li class="contact-item">
              ...
              <a href="#" class="contact-link">Dehradun, Uttarakhand</a>
            </li>
          </ul>
        </div>
        <div className='second-container'>
          <div className='main-info'>
            <div className="username"><span>Username</span> : lorem </div>
